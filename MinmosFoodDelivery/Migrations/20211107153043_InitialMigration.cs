    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AllergenProduct", x => new { x.AllergensAllergenId, x.ProductsProductId });
                    table.ForeignKey(
                        name: "FK_AllergenProduct_Allergens_AllergensAllergenId",
                        column: x => x.AllergensAllergenId,
                        principalTable: "Allergens",
                        principalColumn: "AllergenId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AllergenProduct_Products_ProductsProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AllergenProduct_ProductsProductId",
